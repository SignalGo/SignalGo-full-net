...
namespace SignalGoTest2Services.StreamServices
{
    ...
    public partial class TestServerStreamModel : ITestServerStreamModel
    {
        private SignalGo.Client.ClientProvider CurrentProvider { get; set; }
        string ServiceName { get; set; }
        public TestServerStreamModel(SignalGo.Client.ClientProvider clientProvider)
        {
            CurrentProvider = clientProvider;
            ServiceName = this.GetType().GetServerServiceName(true);
        }
        ...
        {
                return  SignalGo.Client.ClientManager.ConnectorExtensions.SendDataSync<SignalGo.Shared.Models.StreamInfo<string>>(CurrentProvider, ServiceName,"DownloadImage", new SignalGo.Shared.Models.ParameterInfo[]
                {
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(name),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(name) },
        ...
        {
                return SignalGo.Client.ClientManager.ConnectorExtensions.SendDataAsync<SignalGo.Shared.Models.StreamInfo<string>>(CurrentProvider, ServiceName,"DownloadImage", new SignalGo.Shared.Models.ParameterInfo[]
                {
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(name),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(name) },
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(testStreamModel),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(testStreamModel) },
                });
        ...
        {
                return  SignalGo.Client.ClientManager.ConnectorExtensions.SendDataSync<string>(CurrentProvider, ServiceName,"UploadImage", new SignalGo.Shared.Models.ParameterInfo[]
                {
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(name),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(name) },
        ...
        {
                return SignalGo.Client.ClientManager.ConnectorExtensions.SendDataAsync<string>(CurrentProvider, ServiceName,"UploadImage", new SignalGo.Shared.Models.ParameterInfo[]
                {
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(name),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(name) },
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(streamInfo),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(streamInfo) },
                         new  SignalGo.Shared.Models.ParameterInfo() { Name = nameof(testStreamModel),Value = SignalGo.Client.ClientSerializationHelper.SerializeObject(testStreamModel) },
