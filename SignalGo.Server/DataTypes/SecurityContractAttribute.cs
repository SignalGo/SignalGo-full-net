...
namespace SignalGo.Server.DataTypes
{
    ...
    public abstract class SecurityContractAttribute : Attribute
    {
        ...
        public abstract bool CheckPermission(ClientInfo client, object service, MethodInfo method);
        /// <summary>
        ...
        public abstract object GetValueWhenDenyPermission(ClientInfo client, object service, MethodInfo method);
    }
}
