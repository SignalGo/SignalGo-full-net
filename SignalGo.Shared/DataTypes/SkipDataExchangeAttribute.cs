...
namespace SignalGo.Shared.DataTypes
{
    ...
    public class SkipDataExchangeAttribute : Attribute
    {
        ...
        /// skip mode
        /// </summary>
        public SkipExchangeType Mode { get; private set; }
        /// <summary>
        /// constructor of this attrib neeed your strategy mode
        /// </summary>
        /// <param name="mode">strategy mode</param>
        public SkipDataExchangeAttribute(SkipExchangeType mode)
        {
            Mode = mode;
        }
        ...
        /// default value is null, if you want to system use SkipExchangeType for ignore or not ignore object return null
        /// </summary>
